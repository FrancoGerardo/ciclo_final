        ...
        <div class="card-body table-responsive">
            <table class="table" id="marcas">
                <thead class="thead-dark">
                    <tr>
                        <th thead-light class="text-center">ID_Venta</th>
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-2">
                    ...
                    <input type="number"  class="form-control" style="width : 60px; heigth : 1px">
                    
                </div>

                <div class="col-md-3">
                    <label for="parabrisa_id" class="text-center">Parabrisa: </label>
                ...
                <div class="col-md-2">
                    ...
                    <input type="number" class="form-control" style="width : 80px; heigth : 1px">
                </div>
                ...
                <div class="col-md-3">
                    <label for="importe">Importe 2: </label>
                    <input type="number" class="form-control" style="width : 80px; heigth : 1px">
                </div>
            </div>
        </div>
