...
class RolSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Permission::create(['name' => 'Gestionar Facturas'])->syncRoles([$role1,$role2]);
        Permission::create(['name' => 'Reporte de Ventas'])->syncRoles([$role1,$role2]);
        Permission::create(['name' => 'Carritos'])->syncRoles([$role1]);
        Permission::create(['name' => 'proveedores'])->syncRoles([$role1]);
        Permission::create(['name' => 'Nota Ingreso'])->syncRoles([$role1]);
