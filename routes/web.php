...
use App\Http\Controllers\FrontalController;
use App\Http\Controllers\VistasController;
use App\Models\Deseo;
use FrontalController as GlobalFrontalController;
...
//Route::get('/front/1', [CarritoController::class, 'eliminarDetalle'])->name('carritos');
...
//Route::resource('carritos', 'CarritoController@index_publico');
...
Route::get('/hola/v1', [VistasController::class, 'index1'])->name('vistas.index1');
Route::get('/hola/v2', [VistasController::class, 'index2'])->name('vistas.index2');

Route::get('/carrito', [FrontalController::class, 'carrito_index'])->name('frontal.carrito_index');
Route::get('/notaventa', [FrontalController::class, 'notaventa_index'])->name('frontal.notaventa_index');


//Route::get('/carrito/index1', [VistasController::class, 'index1'])->name('vistas.index1');

//Route::get('/vistas', [VistasController::class, 'index2']);
//Route::resource('vistas', VistasController::class)->names('vistas');
//Route::get('vistas/index1', 'VistasController@index1');


Route::resource('notaingresos', NotaingresoController::class)->names('notaingreso');
Route::resource('detallenotaingreso', DetalleNotaIngresoController::class)->names('detallenotaingreso');
...
Route::get('/detallenotaingreso', 'DetalleNotaIngresoController@create');
/////////////////////////////////////////////////////
/////////////////////////////////////////////////////
